...
def learning_curve(state):
	x,y,z = oth.MLE(state)
	a,b = oth.Learning_curve(x,y,z)
	return(a,b)
...
np.save("HBR_LR0.001_BS4_S8_aNb.6N.6_U.npy", u_Statistical_wNe)
################################################# generating lerning curve data ###########################################################################
print('\n'"We are training AI. Please be patient...")
Statistical_lc_a,Statistical_lc_b = learning_curve(state_init)
print(Statistical_lc_a)
print(Statistical_lc_b)
np.savez("HBR_LR0.001_BS4_S8_aNb.6N.6_lc", a =Statistical_lc_a, b = Statistical_lc_b)
print('\n'"Lc is ready!")
################################################# playing with maachine learning ##########################################################################
print('\n'"We are training AI. Please be patient...")
for i in range(25):
...
np.save("HBR_LR0.001_BS4_S8_aNb.6N.6_T.npy", Statistical_wNe)
